                        ...
                        <ul class="list-unstyled">
                            <li class="has-sub">
                                ...
                                <ul class="header3-sub-list list-unstyled">
                                    <li>
                                        <a @click="select=1,menu=1" href="#">Listado</a>
                                    </li>
                            ...
                            <li  class="has-sub">
                                <a href="#">
                                    ...
                                    <ul class="header3-sub-list list-unstyled">
                                    <li>
                                        <a @click="select=2,menu=2" href="#">Listado cliente</a>
                                    </li>
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="header3-sub-list list-unstyled">
                                    <li>
                                        <a @click="select=3,menu=3"  href="#" >Listado Reportes</a>
                                    </li>
                    ...
                    <div class="header__tool">
                        ...
                        <div class="account-wrap">
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                <div class="image">
                                    <img src="images/icon/bbell.png" alt="John Doe" />
                                </div>
                                <div class="content">
                                    <a href="#">                          
                                          Notificación</a>
                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a @click="select=2,menu=2"  href="#">Listado de clientes</a>
                                </li>
                                <li>
                            </ul>
                        </li>
